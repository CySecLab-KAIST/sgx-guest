...
// TODO: Remote all puts' after debug is complete
sigstruct_t *sgx_load_sigstruct(char *conf)
{
    ...
    while (getline(&line, &len, fp) != -1) {
        ...
        {
            load_start = 1;
            sgx_dbg (info, "sigstruct started");
        }
        ...
        if (!strncmp(line, "HEADER        : ", nprefix)) {
            ...
            sgx_dbg (info, "sigstruct header loaded");
            ...
            sgx_dbg (info, "sigstruct vendor loaded");
    ...
    sgx_dbg (info, "closed sigstruct file; I'm prepared to return to the caller.");

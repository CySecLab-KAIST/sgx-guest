...
int sgx_local_attest_challenger(int target_port, char *conf)
{
    int target_fd;
    ...
    //Connect to Target enclave (Local)
...
int sgx_local_attest_target(int challenger_port)
{
    int client_fd;
    targetinfo_t targetinfo;
    keyrequest_t keyreq;
    ...
    //server socket for Challenger enclave (Local)

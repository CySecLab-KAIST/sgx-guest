...
void enclave_main()
{
    ...
    printf("fefore trampoline for EMODT\n\n");
    ...
    printf("after EMODT and EACCEPT\n\n");
    ...
    // handling pending page 
    unsigned long pending_page2 = stub->pending_page; 
    enclu( ENCLU_EACCEPTCOPY, (uint64_t)secinfo, (uint64_t)pending_page2, (uint64_t)pending_page, NULL); 

    printf("after EAUG and EACCEPTCOPY\n\n");

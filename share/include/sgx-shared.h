...
//cch: the following includes prevent lkm from compiling
#ifndef SGX_KERNEL
  #include <inttypes.h>
  #include <time.h>
#endif

// knh: system call entry 177~178 are unused in x64 
#define NR_SYS_RESTRICT_EPC_PERM  177
#define NR_SYS_CHANGE_EPC_TYPE  178

//cch: system call enries 180~185 are unused in x64
#define NR_SYS_SGXINIT          180
#define NR_SYS_CREATE_ENCLAVE   181
#define NR_SYS_STAT_ENCLAVE     182
#define NR_SYS_ADD_EPC          183
#define NR_SYS_GET_ENCLAVE_HEAP      184
#define NR_SYS_DESTROY_ENCLAVE  185
...
#define NUM_EPC                  512 // cch: original value is 1500
#define MIN_ALLOC                2

// Enclave configuration
#define STACK_PAGE_FRAMES_PER_THREAD 2 //cch: original value is 250
#define HEAP_PAGE_FRAMES             2 //cch: original value is 100
#define SSA_PAGE_FRAMES              2
...
typedef enum {
    ...
    FUNC_SEND,
    FUNC_RECV,
    FUNC_AUG,       // knh: for EAUG 
    FUNC_RESTRICT,  // knh: for EMODPR 
    FUNC_TYPE       // knh: for EMODT
    // ...
} fcode_t;
...
typedef struct sgx_stub_info {
    ...
    int  in_arg2;
    uint32_t in_arg3;
    //cch: struct tm is not directly supported in kernel
    //struct tm in_tm;
   ...
   int  out_arg2;
   int  out_arg3;
   //cch: time is not directly supported in kernel
   //time_t out_arg4;
